...
if(isset($_POST['s']))
{
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        $u_id=$_POST['email'];    
        $_SESSION['u_id']=$u_id;
        $result=mysqli_query($connection,"SELECT u_id,u_pass FROM user where u_id='$name' and u_pass='$pass' ");
...
<body style="background-size: cover;
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php" style="margin-top: 5%;"><b>NYAY SARATHI</b></a>
    </div>
